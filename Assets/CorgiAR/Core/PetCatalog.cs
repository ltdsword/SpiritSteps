...
namespace CorgiAR
{
    ...
    public static class PetCatalog
    {
        ...
        public static readonly PetEntry[] Entries =
        {
            ...
            Kit("cur", "Shiba (Kit)"),
            Kit("germanshepherd", "German Shepherd"),

            Uaa("uaa_fox", "Fox", "Fox"),
            Uaa("uaa_husky", "Husky", "Husky"),
            Uaa("uaa_wolf", "Wolf", "Wolf"),
            Uaa("uaa_shiba", "Shiba", "ShibaInu", kitModel: true),
            Uaa("uaa_alpaca", "Alpaca", "Alpaca"),
            Uaa("uaa_deer", "Deer", "Deer"),
            Uaa("uaa_stag", "Stag", "Stag"),
            Uaa("uaa_donkey", "Donkey", "Donkey"),
            Uaa("uaa_bull", "Bull", "Bull"),
            Uaa("uaa_cow", "Cow", "Cow"),
            Uaa("uaa_horse", "Horse", "Horse"),
            Uaa("uaa_horse_white", "White Horse", "Horse_White"),
        };
