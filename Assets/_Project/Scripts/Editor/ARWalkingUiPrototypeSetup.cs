    ...
    public static class ARWalkingUiPrototypeSetup
    {
        ...
        static void CreateCatalog()
        {
            ...
            catalog.landmarks = new List<LandmarkUiData>
            {
                ...
                new LandmarkUiData { id=PrototypeIds.NotreDameBasilica, name="Notre-Dame Basilica", localName="Nhà thờ Đức Bà Sài Gòn", history="Công trình được khởi công xây dựng vào ngày 07/10/1877 và khánh thành vào năm 1880 do kiến trúc sư người Pháp Jules Bourard thiết kế.", architecture="Trải qua bao biến động lịch sử, Nhà thờ chính tòa Đức Bà Sài Gòn đã vượt qua ranh giới của một công trình tôn giáo để trở thành hồn cốt, di sản văn hóa không thể tách rời của đô thị phương Nam.", didYouKnow="Một biểu tượng văn hóa - xã hội của Thành phố Hồ Chí Minh.", imageKey="notre-dame", imageTargetReady=true, companionRewardId=PrototypeIds.Bull }
            };
