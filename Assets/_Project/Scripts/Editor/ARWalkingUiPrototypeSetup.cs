        ...
        static void CreateNavigationGraph()
        {
            ...
            for (var i = 0; i < UiRouteCatalog.All.Count; i++)
            {
                ...
                destination.destinationTemplate = new DefaultDestinationTemplate
                {
                    ...
                    showBottomNavBar = IsRootRoute(route), showAppBar = route != UiRoute.OnboardingSetup && route != UiRoute.LandmarkArMemory && route != UiRoute.ArPhoto,
            ...
            Link(asset, destinations[UiRoute.LandmarkDetail], "open_ar_memory", destinations[UiRoute.LandmarkArMemory]);
            Link(asset, destinations[UiRoute.LandmarkArMemory], "take_photo", destinations[UiRoute.ArPhoto]);
