    ...
    public static class ARWalkingUiPrototypeSetup
    {
        ...
        static void CreateCatalog()
        {
            ...
            catalog.foods = new List<FoodUiData>
            {
                ...
                new FoodUiData { id=FoodCatalogIds.ChickenLeg, name="Chicken Leg", coinCost=50, growthExperience=40, description="A hearty drumstick treat for any unlocked companion." }
            };
